	...
	<div class="wrapper">
		...
		<div class="crumbs">
			<ul id="breadcrumbs" class="breadcrumb">
				<li><a href="index.html">Lotes</a></li>
		...
		<div class="span12">
			<form id="formResultadoPersona" method="POST">
				<fieldset>
					...
					<input type="hidden" name="oper" id="oper" value="completarDDJJ" /> <input
						type="hidden" name="hfIdPer" id="hfIdPer"
						value="<?php echo $idP; ?>" /> <input type="hidden"
						name="hfIdLote" id="hfIdLote" value="<?php echo $idL; ?>" />
						<input type="hidden"
						name="hfIdLP" id="hfIdLP" value="" />

					<div id="divDDJJ" class="span12">
						...
						<div class="widget row-fluid">
								...
								<div class="row-fluid">
									<div class="span4">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" class="validate[required] span8" id="txtNroCedula"
													name="txtNroCedula" readonly="readonly" >
											</div>
										</div>
									</div>
								</div>	
										...
										<div class="control-group">
											...
											<div class="controls">
												<select name="cbResultado" id="cbResultado"
													...
													data-prompt-position="topLeft:-1,-5">
													<option value="">...</option>
													<option value="1">Notifici&oacute;n Generada</option>
													<option value="2">Notifici&oacute;n Enviada</option>
													<option value="6">Notifici&oacute;n Recibida</option>
													<option value="4">NO se Notific&oacute;</option>
													<option value="5">Se Notific&oacute; y NO se recibi&oacute;
														la Declaraci&oacute;n Jurada</option>
								...
								<div class="row-fluid">
									<div class="span4">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" class="datepicker validate[funcCall[valNoNot]] span8"
													data-mask="99/99/9999"  id="txtNotificacion" data-prompt-position="topLeft:-1,-5"
													name="txtNotificacion"  placeholder="99/99/9999">
											</div>
										</div>
									</div>
									<div class="span4">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" class="datepicker span8"
													data-mask="99/99/9999" id="txtIntimacion" data-prompt-position="topLeft:-1,-5"
													name="txtIntimacion" placeholder="99/99/9999" />
											</div>
										</div>
									</div>
									<div class="span4">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" class="datepicker validate[funcCall[valNoRec]] span8"
													data-mask="99/99/9999" id="txtRecepcion" data-prompt-position="topLeft:-1,-5"
													name="txtRecepcion" placeholder="99/99/9999" />
											</div>
										</div>
									</div>
								</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea id="txtObservacionesEst"
													name="txtObservacionesEst" class="validate[funcCall[valOb]] span12" ></textarea>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="span12">
								...
								<label class="radio inline">
									<input name="rbApto" id="rbSi" value="1" type="radio" class="validate[funcCall[valchekApto]]">Apto
								</label>
								<label class="radio inline">
									<input name="rbApto" id="rbNO" value="0" type="radio" class="validate[funcCall[valchekApto]]">No Apto
								</label>
								</div>
								</div>
							</div>
								<div class="row-fluid apto">
									<div class="span6">
										<div class="control-group">
					...
					<a id="btncancel" href="lot_personasXLote.php?id=<?php echo $idL; ?>" class="btn btn-default">Cerrar</a>
					</div>
					</div>
					<!-- / DDJJ -->
