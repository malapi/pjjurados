...
?>
		...
		<div id="content">
		    ...
		    <div class="wrapper">
	            ...
	            <form id="formNuevo" method="POST">
					<fieldset>
						...
						<div class="widget row-fluid">	
							...
							<div class="navbar"><div class="navbar-inner"><h6>Nuevo Circuito</h6></div></div>
						    <div class="well">						    	
				...
				<div class="span12">
				<div class="form-actions align-right">
                   <button id="btnNueva" type="button" class="btn btn-info">Cargar Circuito</button>
                </div>
				</div>
...
<script type="text/javascript" src="js/circuitos.js"></script>
