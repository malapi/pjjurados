		    ...
		    <div class="wrapper">
			    ...
			    <div class="crumbs">
		            <ul id="breadcrumbs" class="breadcrumb"> 
		                ...
		                <li><a href="#">Emitir Listados de la Persona</a></li>
		            </ul>
			    </div>
			    <!-- /breadcrumbs line -->
			    ...
			    <div class="page-header">
			    	<div class="page-title">
				    	<h5>Emitir Listados  de la Persona</h5>
			    	</div>
			    </div>
			    <!-- /page header -->
	            ...
	            <form id="formEmitirListados" method="POST" >
						...
						<div class="widget row-fluid">	
							...
							<input type="hidden" name="accion" id="accion" value="listadosPersona" />
...
<script type="text/javascript" src="js/persona_emitirlistados.js"></script>
