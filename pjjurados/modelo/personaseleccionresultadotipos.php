...
class personaseleccionresultadotipos extends BaseDatos{ 

		private $nombreTabla='personaseleccionresultadotipos';

		private $prefijo= array("id","psrt","completar");

		private $textoCombo = "psrtdescripcion";
