	...
	<div class="wrapper">
		...
		<div class="page-header">
			<div class="page-title">
				<h5>Generar Cedulas de Notificaci&oacute;n</h5>
				<span></span>
			</div>
		</div>
		<!-- /page header -->
					...
					<div class="widget row-fluid">	
						<div class="well">
								...
								<div class="span12">
								 <div class="control-group">
                                     <label class="control-label">Iniciar Nro C&eacute;dula en:</label>
                                      <div class="controls">
                                       <input type="text" class="span2" id="txtNroCedula"
												name="txtNroCedula" />
                                      </div>
                                </div>
								</div>
							...
							<div class="row-fluid">
								<div class="span12">
								 <div class="control-group">
                                        <label class="control-label">Plantilla Para C&eacute;dula Notificaci&oacute;n:</label>
                                        <div class="controls" >
							...
							<div class="row-fluid">
								<div class="span12">
								 <div class="control-group">
	                                        <label class="control-label">Plantilla Para Sobres Notificaci&oacute;n:</label>
	                                        <div class="controls" >
	                                              <div id="uploadSo" class="btn btn-primary"><span><i class="ico-file"> </i> Adjuntar Plantilla Sobres </span></div>
							...
							<div class="form-actions align-right">
								...
								<a id="btnImprimirCedula" href="doc_imprimirCedulasNot.php?idL=<?php echo $id; ?>"
