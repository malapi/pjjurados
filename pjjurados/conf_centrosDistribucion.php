		    ...
		    <div class="wrapper">
			    ...
			    <div class="crumbs">
		            <ul id="breadcrumbs" class="breadcrumb"> 
		                ...
		                <li><a href="#">Centros de Distribuci&oacute;n</a></li>
		            </ul>
			    </div>
			    <!-- /breadcrumbs line -->
			    ...
			    <div class="page-header">
			    	<div class="page-title">
				    	<h5>Centros de Distribuci&oacute;n</h5>
				    	<span></span>
			    	</div>
			    </div>
			    <!-- /page header -->
	            ...
	            <form id="formNuevo" method="POST">
					<fieldset>
						...
						<div class="widget row-fluid">	
							...
							<div class="navbar"><div class="navbar-inner"><h6>Nuevo Centro de Distribuci&oacute;n</h6></div></div>
						    <div class="well">						    	
						        <div class="control-group">
                                     <label class="control-label">Localidad:</label>
                                     <div class="controls">
                                      <select name="cbLocalidad" id="cbLocalidad" class="validate[required] span12" data-prompt-position="topLeft:-1,-5" >
                                           <option value="">...</option>
                                       </select>
                                      </div>
                                </div>
						...
						<div class="widget row-fluid">	
						    ...
						    <div class="well">		
						    	<div class="control-group">
                                     <label class="control-label">Localidad:</label>
                                     <div class="controls">
                                      <select name="cbLocalidadM" id="cbLocalidadM" class="validate[required] span12" data-prompt-position="topLeft:-1,-5" >
                                           <option value="">...</option>
                                       </select>
                                      </div>
                                </div>				    	
				...
				<div class="span12">
				<div class="form-actions align-right">
                   <button id="btnNueva" type="button" class="btn btn-info">Cargar Centro de Distribuci&oacute;n</button>
                </div>
				</div>
...
<script type="text/javascript" src="js/centrosDist.js"></script>
